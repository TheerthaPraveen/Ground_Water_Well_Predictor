...
#         result = {"Well_Suitability": well_suitability}

#         # ONLY add depth and discharge if the well is suitable
#         if well_suitability == "Suitable":
#             result["Depth"] = round(prediction[0][1], 2)
#             result["Discharge"] = round(prediction[0][2], 2)

#         print(f"Prediction Result Sent to Template: {result}")
#         return result
